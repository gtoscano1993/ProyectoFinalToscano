...
function renderCarrito() {
    ...
    contenido += `<tr>
    <td class="p-4 text-center" colspan='2'>Total a Pagar</td>
    ...
    <td class="text-end"><button class="btn colorFondo2 btn-sm" onclick="finalizarCompra()" Title="Finalizar Compra"><b>Finalizar Compra</b></button></td>
        ...
        contenido = `<h1 class= "colorFuente bangers-regular text-center my-5 p-5">No se encontraron productos en el Carrito!</h1>`;
    }
